 ...
 * banners tightened, not a rewrite. Diff the git history (`orgames.js` /
 * `methods.js`, pre-2026-08-18) against either section if you need to confirm
 * that.
 * ========================================================================== */
 ...
 * at run time. Nothing here is a designer's guess. Rebuilt 2026-07-30 with
 * levels, after an audit found five real defects: the knapsack's items were
 * never shown to the player, neither game had a mid-game restart, the
 * Bottleneck never said what its products earned, the tree squeezed instead
 * of scrolling, and there was no undo anywhere.
 * ────────────────────────────────────────────────────────────────────── */
(function () {
 ...
 * every comparison omits: WHAT CERTIFICATE IT ENDS UP HOLDING.
 *
 * That is the whole point. A number without a certificate is a claim; a
