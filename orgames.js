  ...
  G.prune = {
    ...
    mount: function (root, opts) {
      ...
      var LEVELS = [
        ...
        { name: 'The van', cap: 55, par: 27, gate: 31, opt: 280, bfs: 204, grover: 17,
